...
rm -rf /opt/wine/{lib,lib32}/xinput*
rm -rf /opt/wine/{lib,lib32}/dinput*
rm -rf /opt/wine/{lib,lib32}/dplay*
rm -rf /opt/wine/{lib,lib32}/dsound*
rm -rf /opt/wine/{lib,lib32}/dxdiag*
rm -rf /opt/wine/{lib,lib32}/twain*
rm -rf /opt/wine/{lib,lib32}/wined3d*
rm -rf /opt/wine/{lib,lib32}/dplayx*
rm -rf /opt/wine/{lib,lib32}/dmusic*
rm -rf /opt/wine/{lib,lib32}/wordpad*
